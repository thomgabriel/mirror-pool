...
//! verifying key for the withdraw circuit, converted to the
...
//! `prover::prove_withdraw` are guaranteed to speak the same byte format.
...
mod tests {
    ...
    fn renders_expected_shape_for_a_minimal_vk() {
        ...
        assert!(rendered.contains("pub const WITHDRAW_VK"));
